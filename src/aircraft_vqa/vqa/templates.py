...
Q_GROUNDING_SINGLE = [
    ...
    "只标{defect}这一类，其他不用管，JSON 输出。",
    "请给出该{obj}上{defect}的全部检出框。",
    "把{defect}的位置圈出来，用 JSON 表示。",
...
Q_GROUNDING_ALL = [
    ...
    "把该{ctx}上所有不合格的地方框出来，注明是什么问题。",
    "请给出这张图上全部异常的检测结果，JSON 格式。",
    "完整扫一遍这张{obj}照片，所有缺陷都要标出来。",
...
Q_DESCRIBE = [
    ...
    "说说这张图的情况。",
    "请为该{obj}写一条目视检查记录。",
    "把这张{ctx}照片上看到的情况描述一下。",
    "请概括该{obj}的外观检查结果。",
    "这张图记录一下：部件是什么、发现了什么、在哪。",
    "请用一段话说明图中{ctx}的状况。",
    "帮我把这张{obj}照片的检查情况整理成文字。",
    "请描述图中可见的全部异常及其分布。",
    "简要说明该{ctx}的表面状况。",
]
